    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean  {
        ...
        private fun setupUI(weatherList: WeatherResponse) {
            for (i in weatherList.weather.indices) {
                ...
                tv_minTemp.text =
                    "Min " + weatherList.main.temp_min.toString() + getUnit(application.resources.configuration.toString())
                tv_maxTemp.text =
                    "Max " + weatherList.main.temp_max.toString() + getUnit(application.resources.configuration.toString())
